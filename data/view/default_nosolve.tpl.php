...
<? } } ?>
                        ...
                        <? if($user['uid']>0) { ?>                        <div class="mt10">
                            ...
                            <? } elseif($user['uid']==$answer['authorid']) { ?>                            <input type="button" class="button_4" value="修改答案"  onclick="javascript:document.location = '<?=SITE_URL?>question/editanswer/<?=$answer['id']?>/0.html'" />
