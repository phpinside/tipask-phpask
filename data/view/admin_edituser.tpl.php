...
</table><? } ?><form action="index.php?admin_user/edit<?=$setting['seo_suffix']?>" method="post">
...
<option <? if($member['groupid'] == $group['groupid']) { ?>selected<? } ?> value="<?=$group['groupid']?>"><?=$group['grouptitle']?></option>
<? } } ?>
</optgroup>
...
<td class="altbg2"><input class="text"  name="credit1" value="<?=$member['credit1']?>" /></td>
</tr>
<tr>
...
<td class="altbg2">
<input class="radio" id="pmcenteryes"  type="radio"  <? if($member['gender']) { ?>checked<? } ?> value="1" name="gender"><label for="pmcenteryes">帅哥</label>&nbsp;&nbsp;&nbsp;
<input class="radio" id="pmcenterno"   type="radio" <? if(!$member['gender']) { ?>checked<? } ?> value="0" name="gender"><label for="pmcenterno">美女</label>
</td>
</tr>
<tr>
<td class="altbg1" width="45%"><b>生日:</b><br><span class="smalltxt">手机、固话都可以</span></td>
<td class="altbg2"><input class="text"  name="bday" value="<?=$member['bday']?>" onclick="showcalendar();" /></td>
</tr>
<tr>
<td class="altbg1" width="45%"><b>联系电话:</b><br><span class="smalltxt">用户出生日期</span></td>
