...
<? } } ?>
        ...
        <div class="mod-best-a js-form">
            ...
            <div class="bd">
                <div class="qa-content"><?=$bestanswer['content']?></div>
            </div>
            <div id="gift_box" class="ft">
                <div class="user-vcard clearfix">
                    <div class="info">
                        <a target="_blank" href="<?=SITE_URL?>?u-<?=$bestanswer['authorid']?>.html"><img src="<?=$bestanswer['author_avartar']?>" onmouseover="pop_user_on(this, '<?=$answer['authorid']?>', 'image');"  onmouseout="pop_user_out();"></a>
                    </div>
                    <div class="text">
                        <p class="name"><a target="_blank" href="<?=SITE_URL?>?u-<?=$bestanswer['authorid']?>.html"><?=$bestanswer['author']?></a></p>
                        <div class="user-info">
        ...
        <div id="customerList" class="net-answer mt10">
            <div class="title">全部回答(<?=$rownum?>)</div>
