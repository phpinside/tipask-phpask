    ...
    <div class="aside-right">
        <div class="modbox">
            ...
            <div class="rcontent clearfix">
                <h3>友情提示:</h3>
                <span>·我们提醒您注意，您需要注册并登陆，才能享受我们的完整服务进行各项操作。</span>
                <span>·密码过于简单有被盗的风险，一旦密码被盗你的个人信息有泄漏的危险。<br /></span>
                <span>·我们拒绝垃圾邮件，请使用有效的邮件地址</span>
            </div>
        </div>		
    </div>
...
<script type="text/javascript">
                            ...
                            function docheck() {
                                <? if($setting['code_register']) { ?>                                return (usernameok && repasswdok && emailok && check_code());
