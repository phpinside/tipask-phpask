...
class usergroupmodel {
    ...
    function update($groupid,$group) {
        $this->db->query('update  '.DB_TABLEPRE."usergroup  set grouptitle='$group[grouptitle]',creditslower='$group[creditslower]',creditshigher='$group[creditshigher]',questionlimits=$group[questionlimits],answerlimits=$group[answerlimits],credit3limits=$group[credit3limits],regulars='$group[regulars]' where groupid=$groupid ");
    }
    /**
     * 得到用户组信息
     *
